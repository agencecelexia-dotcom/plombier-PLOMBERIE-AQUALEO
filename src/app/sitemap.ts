...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/depannage-fuite`, lastModified, changeFrequency: "monthly", priority: 0.9 },
    { url: `${baseUrl}/plomberie`, lastModified, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/plomberie-generale`, lastModified, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/renovation-salle-de-bain`, lastModified, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/installation-sanitaire`, lastModified, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/chauffage`, lastModified, changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/chauffe-eau`, lastModified, changeFrequency: "monthly", priority: 0.7 },
